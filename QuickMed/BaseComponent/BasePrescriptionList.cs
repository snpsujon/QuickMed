...
namespace QuickMed.BaseComponent
{
    public class BasePrescriptionList : ComponentBase
    {
     ...
     DateTime? endDate = null, string? brand = null)
        ...
        pres != null
            ? $@"
                <div style='display: flex; justify-content: flex-end;'>
                    ...
                    <i class='dripicons-preview btn btn-soft-success dTRowActionBtn' data-id='{pres.PrescriptionCode}' data-method='OnViewClick'></i>
                     <i class='dripicons-pencil btn btn-soft-primary dTRowActionBtn mx-2' data-id='{pres.PrescriptionCode}' data-method='OnEditClick'></i>
        ...
        public void OnEditClick(string code)
        {
            NavigationManager.NavigateTo($"/prescription?code={code}&ispreview=false");

        }
        [JSInvokable("OnViewClick")]
        public void OnViewClick(string code)
        {
            NavigationManager.NavigateTo($"/prescription?code={code}&ispreview=true");
